...
def trace_gen(chip_level_count_entry, saMap):

	# output trace file
	output_prefix = '/home/lw2ef/Documents/workspace/DRAM_DB/ramulator-master/SSB_trace/Fulcrum_Mode_One/'
	trace_file = output_prefix + 'Fulcrum_Mode_One.trace'
	...
	input_q_file = '/home/lw2ef/Documents/workspace/DRAM_DB/ramulator-master/SSB_trace/sf_100_row_major_trace_files/Fulcrum_mode1_sf100_row_major.trace' 
	...
	with open(input_q_file, 'r') as sa_trace_f:
		...
		for line in sa_trace_f:
			...
			# print('%s, %d' % (parsed_line,len(parsed_line))) # DEBUG: 7 or 10
...
trace_gen(chip_level_count_entry, saMap) # all query performs the same since the same rows
