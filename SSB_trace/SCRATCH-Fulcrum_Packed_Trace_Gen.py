...
def findNumUsedSAs(query_index):
	...
	input_prefix = '/home/lw2ef/Documents/workspace/DRAM_DB/ramulator-master/SSB_trace/Fulcrum_packed_sf_1/' 
	if query_index < 9:
		input_q_file = input_prefix + 'packed_q0'+str(query_index+1)+'.trace'
	else:
		input_q_file = input_prefix + 'packed_q'+str(query_index+1)+'.trace'
...
def trace_gen(chip_level_count_entry, usedSAMap, query_index):
	...
	output_prefix = '/home/lw2ef/Documents/workspace/DRAM_DB/ramulator-master/SSB_trace/Fulcrum_packed_sf_1/' 
	trace_file = output_prefix + q_s + '_Fulcrum_Packed_sf_1.trace'
...
print('Distributing used SubArrays among all chans/ranks/banks')
# TODO find how many SA are used
...
for i in range(0, 1):
	q_s = 'Q' + str(i+1)
	print('%s Fulcrum trace gen packed sf_1 ... ' % q_s)
