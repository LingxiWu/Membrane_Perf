    ...
    read_latency(speed_entry.nCL + speed_entry.nBL)
{
    ...
    // printf("SALP.cpp SALP() org_entry.dq:%lu\n",long(org_entry.dq));
    // printf("SALP.cpp SALP() org_entry.size: %lu\n",long(org_entry.size));
    // printf("SALP.cpp SALP() org_entry.count[int(Level::Column)]: %d\n",org_entry.count[int(Level::Column)]);
    // printf("SALP.cpp SALP() (1<<20): %d\n",(1<<20));

    org_entry.count[int(Level::Row)] = long(org_entry.size) * (1<<20) / tmp;
    // printf("SALP.cpp SALP() org_entry.count[int(Level::Row)]: %d\n",(org_entry.count[int(Level::Row)]));
...
void SALP::init_speed()
{
    ...
    switch (speed_entry.rate) {
        ...
        // case 2133: speed_entry.nRRD = (page==1) ? 5 : 6; speed_entry.nFAW = (page==1) ? 6 : 9; break;
