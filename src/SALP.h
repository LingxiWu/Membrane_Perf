...
public:
    ...
    struct OrgEntry {
        ...
        {4<<10,  4, {0, 0, 8, 0, 0, 1<<11}}, {4<<10,  8, {0, 0, 8, 0, 0, 1<<10}}, {4<<10, 16, {0, 0, 16, 0, 0, 1<<10}},
        {8<<10,  4, {0, 0, 8, 0, 0, 1<<12}}, {8<<10,  8, {0, 0, 128, 0, 0, 1<<11}}, {8<<10, 16, {0, 0, 8, 0, 0, 1<<10}}
    }, org_entry;
    ...
    struct SpeedEntry {
        ...
        // {2133, (400.0/3)*8, (3/0.4)/8, 4, 0, 2, 0, 0, 13, 1, 10, 36, 49, 8, 8, 0, 7, 22, 0, 0, 0, 8320, 6, 7, 26, 7, 0, 512, 1}
    }, speed_entry;
