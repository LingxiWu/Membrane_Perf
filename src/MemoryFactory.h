...
public:
    static void extend_channel_width(T* spec, int cacheline)
    {
        ...
        printf("MemoryFactory::extend_channel_width() cacheline %d\n",cacheline);
        printf("MemoryFactory::extend_channel_width() channel_unit %d\n",channel_unit);
        printf("MemoryFactory::extend_channel_width() gang_number %d\n",gang_number);
